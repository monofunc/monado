...
\
    _(XRT_INPUT_DTRACK_CONTROLLER_TRIGGER_CLICK        , XRT_INPUT_NAME(0xA000, VEC1_ZERO_TO_ONE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_1_CLICK              , XRT_INPUT_NAME(0xA001, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_2_CLICK              , XRT_INPUT_NAME(0xA002, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_3_CLICK              , XRT_INPUT_NAME(0xA003, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_4_CLICK              , XRT_INPUT_NAME(0xA004, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_THUMBSTICK_CLICK     , XRT_INPUT_NAME(0xA005, BOOLEAN)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_THUMBSTICK           , XRT_INPUT_NAME(0xA006, VEC2_MINUS_ONE_TO_ONE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_GRIP_POSE            , XRT_INPUT_NAME(0xA007, POSE)) \
    _(XRT_INPUT_DTRACK_CONTROLLER_AIM_POSE             , XRT_INPUT_NAME(0xA008, POSE)) \
\
    _(XRT_INPUT_JOY_CON_ZL_CLICK                       , XRT_INPUT_NAME(0xB000, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_L_CLICK                        , XRT_INPUT_NAME(0xB001, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_MINUS_CLICK                    , XRT_INPUT_NAME(0xB002, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_SL_CLICK                       , XRT_INPUT_NAME(0xB003, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_SR_CLICK                       , XRT_INPUT_NAME(0xB004, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_UP_CLICK                       , XRT_INPUT_NAME(0xB005, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_LEFT_CLICK                     , XRT_INPUT_NAME(0xB006, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_DOWN_CLICK                     , XRT_INPUT_NAME(0xB007, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_RIGHT_CLICK                    , XRT_INPUT_NAME(0xB008, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_CAPTURE_CLICK                  , XRT_INPUT_NAME(0xB009, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_THUMBSTICK                     , XRT_INPUT_NAME(0xB00A, VEC2_MINUS_ONE_TO_ONE)) \
    _(XRT_INPUT_JOY_CON_THUMBSTICK_CLICK               , XRT_INPUT_NAME(0xB00B, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_GRIP_POSE                      , XRT_INPUT_NAME(0xB00C, POSE)) \
    _(XRT_INPUT_JOY_CON_AIM_POSE                       , XRT_INPUT_NAME(0xB00D, POSE)) \
\
    _(XRT_INPUT_JOY_CON_ZR_CLICK                       , XRT_INPUT_NAME(0xB00E, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_R_CLICK                        , XRT_INPUT_NAME(0xB00F, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_PLUS_CLICK                     , XRT_INPUT_NAME(0xB010, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_X_CLICK                        , XRT_INPUT_NAME(0xB011, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_Y_CLICK                        , XRT_INPUT_NAME(0xB012, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_A_CLICK                        , XRT_INPUT_NAME(0xB013, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_B_CLICK                        , XRT_INPUT_NAME(0xB014, BOOLEAN)) \
    _(XRT_INPUT_JOY_CON_HOME_CLICK                     , XRT_INPUT_NAME(0xB015, BOOLEAN)) \
// clang-format on
