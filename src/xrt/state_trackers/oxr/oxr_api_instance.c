...
#define EXT_RESULT(VAL) if (value == VAL) { snprintf(buffer, XR_MAX_RESULT_STRING_SIZE, #VAL); } else
	...
	default:
		...
		EXT_RESULT(XR_ERROR_ACTION_SETS_DIFFERENT_INSTANCE_ACTION_CONTEXT_NV)
		EXT_RESULT(XR_ERROR_ACTION_SET_ALREADY_ATTACHED_TO_SESSION_CONTEXT_NV)
#endif
		{
...
#ifdef OXR_HAVE_NVX1_action_context
		EXT_TYPE(XR_TYPE_INSTANCE_ACTION_CONTEXT_CREATE_INFO_NV)
		EXT_TYPE(XR_TYPE_SESSION_ACTION_CONTEXT_CREATE_INFO_NV)
		EXT_TYPE(XR_TYPE_INSTANCE_ACTION_CONTEXT_INFO_NV)
		EXT_TYPE(XR_TYPE_ACTIONS_SYNC_INFO_2_NV)
		EXT_TYPE(XR_TYPE_ACTIONS_SYNC_STATE_2_NV)
		EXT_TYPE(XR_TYPE_INTERACTION_PROFILE_GET_INFO_2_NV)
		EXT_TYPE(XR_TYPE_SESSION_ACTION_CONTEXT_INFO_NV)
#endif
		{
