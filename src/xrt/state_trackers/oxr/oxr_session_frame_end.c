...
oxr_session_frame_end(struct oxr_logger *log, struct oxr_session *sess, const XrFrameEndInfo *frameEndInfo)
{
	...
	for (uint32_t i = 0; i < frameEndInfo->layerCount; i++) {
		...
		case XR_TYPE_COMPOSITION_LAYER_PROJECTION:
			res = oxr_verify_projection_layer(sess, log, i, (XrCompositionLayerProjection *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_QUAD:
			res = oxr_verify_quad_layer(sess, log, i, (XrCompositionLayerQuad *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_CUBE_KHR:
			res = oxr_verify_cube_layer(sess, log, i, (XrCompositionLayerCubeKHR *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_CYLINDER_KHR:
			res = oxr_verify_cylinder_layer(sess, log, i, (XrCompositionLayerCylinderKHR *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_EQUIRECT_KHR:
			res = oxr_verify_equirect1_layer(sess, log, i, (XrCompositionLayerEquirectKHR *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_EQUIRECT2_KHR:
			res = oxr_verify_equirect2_layer(sess, log, i, (XrCompositionLayerEquirect2KHR *)layer, true);
			break;
		case XR_TYPE_COMPOSITION_LAYER_PASSTHROUGH_FB:
			res = oxr_verify_passthrough_layer(log, i, (XrCompositionLayerPassthroughFB *)layer);
			break;
		default:
			return oxr_error(log, XR_ERROR_LAYER_INVALID,
