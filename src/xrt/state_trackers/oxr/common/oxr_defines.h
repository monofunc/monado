...
// NV action context (instance and session)
#define OXR_XR_DEBUG_INSTANCE_ACTION_CONTEXT_NV       (*(uint64_t *)"oxriacn\0")
#define OXR_XR_DEBUG_SESSION_ACTION_CONTEXT_NV        (*(uint64_t *)"oxrsacn\0")
// body tracker (FB)
