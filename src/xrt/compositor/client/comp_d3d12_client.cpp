...
static xrt_result_t
client_d3d12_compositor_set_min_frame_interval(struct xrt_compositor *xc, int64_t min_frame_interval_ns)
{
	struct client_d3d12_compositor *c = as_client_d3d12_compositor(xc);
...
try {
	...
	c->base.base.set_min_frame_interval = client_d3d12_compositor_set_min_frame_interval;
